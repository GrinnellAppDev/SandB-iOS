...
- (void)setupNavBarAppearance
{
    [[UINavigationBar appearance]
     setBarTintColor:[UIColor colorWithRed:140.0/255.0 green:29.0/255.0 blue:41.0/255.0 alpha:1.0]];
...
{
    NSString *defaultReadingOptionsPath = [[NSBundle mainBundle] pathForResource:@"DefaultReadingOptions"
                                                                          ofType:@"plist"];
