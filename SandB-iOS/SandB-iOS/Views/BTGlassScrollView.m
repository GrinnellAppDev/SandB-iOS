...
- (void)setFrame:(CGRect)frame
{
    ...
    [_constraintView setFrame:CGRectMake(0, 0, frame.size.width + DEFAULT_MAX_BACKGROUND_MOVEMENT_HORIZONTAL, frame.size.height + DEFAULT_MAX_BACKGROUND_MOVEMENT_VERTICAL)];
...
- (void)createBackgroundView
{
   ...
   [_backgroundImageView setTranslatesAutoresizingMaskIntoConstraints:NO];
    ...
    [_constraintView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|[_backgroundImageView]|" options:0 metrics:0 views:NSDictionaryOfVariableBindings(_backgroundImageView)]];
    [_constraintView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|[_backgroundImageView]|" options:0 metrics:0 views:NSDictionaryOfVariableBindings(_backgroundImageView)]];
    
    
    
    [_constraintView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|[_blurredBackgroundImageView]|" options:0 metrics:0 views:NSDictionaryOfVariableBindings(_blurredBackgroundImageView)]];
    [_constraintView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|[_blurredBackgroundImageView]|" options:0 metrics:0 views:NSDictionaryOfVariableBindings(_blurredBackgroundImageView)]];
